          ...
          {papers.map((paper, idx) => (
            ...
            >
              <div className="mb-4 sm:mb-0">
                ...
                <p className="text-sm text-gray-500">Download or view the paper in PDF format</p>
                {paper.subject && (
              ...
              <div className="flex gap-4 mt-4 sm:mt-0">
                <a
                  ...
                  className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white px-4 py-2 rounded-lg text-sm font-medium shadow transition-all duration-300"
                >
                  👁️ View PDF
                </a>
                <a
                  ...
                  rel="noopener noreferrer"
                  download
                  className="bg-white border border-amber-600 text-amber-700 px-4 py-2 rounded-lg text-sm font-medium hover:bg-amber-100 transition-all duration-300"
                >
                  ⬇️ Download
                </a>
              </div>
