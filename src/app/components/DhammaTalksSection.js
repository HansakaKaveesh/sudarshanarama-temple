...
export default function DhammaTalksSection() {
  ...
  return (
    <section className="py-20 px-6 md:px-10 lg:px-20 bg-gradient-to-b from-yellow-50 via-amber-50 to-white">
      {/* Section Heading */}
      <motion.div
      ...
      >
        ...
        <div className="w-24 h-1 bg-yellow-700 mx-auto rounded-full mb-5" />
          ...
          >
            ...
            <div className="p-5">
              ...
              <a
                ...
                className="inline-block text-red-600 hover:text-red-800 font-medium text-sm transition-colors"
              >
                ▶️ Watch on YouTube
              </a>
            </div>
      ...
      >
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center bg-red-600 hover:bg-red-700 text-white text-lg px-8 py-3 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1"
        >
          <svg
